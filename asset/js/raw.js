...
// THIS FILE JUST FOR LEARNING PURPOSE, SOURCE: https://raw.github.com/densitydesign/raw
...
!function (exports){
    ...
    raw.parser = function (delimiter) {
        ...
        function detectDelimiter(string){
            ...
            var res = maxCount == 0 ? '\0' : delimiters[delimitersCount.indexOf(maxCount)];
            console.log("detect Delimiter: " + res);
            return res;
        }
